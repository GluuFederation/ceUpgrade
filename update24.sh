...
OXIDP="/opt/gluu-server24/opt/idp/war"
OXCAS="/opt/gluu-server24/opt/dist"
OXTRUST="/opt/gluu-server24/opt/$TOMCATDIRVER/webapps"
OXAUTH="/opt/gluu-server24/opt/$TOMCATDIRVER/webapps"
UPDATER="/opt/gluu-server24/opt/gluu-server-updater/$VER/dist"
GLUU_SERVER="/etc/init.d/gluu-server24"
GLUU_PATH="/opt/gluu-server24"
